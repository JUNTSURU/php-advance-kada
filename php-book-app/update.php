...
if(isset($_POST['submit'])){
  try{
    ...
    book_name= :book_name,
    price =:price,
    stock_quantitiy=:stock_quantitiy,
    ...
    $stmt_update->bindValue(':stock_quantitiy',$_POST['stock_quantitiy'],PDO::PARAM_INT);
...
<main>
  <article class="registration">
    ...
    <div>
      ...
      <input type="number" name="book_code" value="<?= $book['book_code']?>" min="0" max="10000" required>

      <label for="book_name">書籍名</label>
      <input type="text" name="book_name" value="<?= $book['book_name']?>" maxlength="50" required>

      <label for="price">単価</label>
      <input type="number" name="price" value="<?= $book['price']?>" min="0" max="10000" required>

      <label for="stock_quantitiy">在庫数</label>
      <input type="number" name="stock_quantitiy" value="<?= $book['stock_quantitiy']?>" min="0" max="10000" required>
